...
void MCP2510_WriteBits(int ,int ,int );
//void MCP2510_WriteBits(int ,int ,int );
//unsigned char MCP2510_SRead( int );
//unsigned char MCP2510_SRead( int address);
void MCP2510_Swrite(int , unsigned char,unsigned char );
//void MCP2510_Swrite(int address,unsigned char value)
...
void SendSIOData(unsigned char );
//void CAN_Test(void);
